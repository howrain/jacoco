	...
	public IReportVisitor createVisitor(final IMultiReportOutput output)
		...
		return new IReportVisitor() {
			...
			public void visitBundle(final IBundleCoverage bundle,
					final ISourceFileLocator locator, String projectName,
					String appName, String envName, String timeStr)
					throws IOException {
				final BundlePage page = new BundlePage(bundle, null, locator,
						root, HTMLFormatter.this, projectName, appName, envName,
						timeStr);
				// 去掉session页
