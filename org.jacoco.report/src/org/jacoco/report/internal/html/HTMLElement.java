...
public class HTMLElement extends XMLElement {
	...
	public HTMLElement ul() throws IOException {
		return element("ul");
	}

	public HTMLElement ul(final String classattr) throws IOException {
		final HTMLElement ul = ul();
		ul.classattr(classattr);
		return ul;
	}

	public HTMLElement li() throws IOException {
		return element("li");
	}

	public HTMLElement li(final String classattr) throws IOException {
		final HTMLElement li = li();
		li.classattr(classattr);
		return li;
	}

	public HTMLElement i() throws IOException {
		return element("i");
	}

	public HTMLElement i(final String classattr) throws IOException {
		final HTMLElement i = i();
		i.classattr(classattr);
		return i;
	}

	public HTMLElement input() throws IOException {
		return element("input");
	}

	public HTMLElement input(final String classattr) throws IOException {
		final HTMLElement input = input();
	...
	public void scriptContent(final String scriptString) throws IOException {
		final HTMLElement script = element("script");
		script.attr("type", "text/javascript");
		// script.attr("src", "");
		script.text(scriptString, false);
		script.close();
	}
