...
public class PackagePage extends TablePage<IPackageCoverage> {
	...
	public void render(String projectName, String appName, String envName,
		...
		if (sourceCoverageExists) {
			packageSourcePage.render(projectName, appName, envName, timeStr);
		}
		renderClasses(projectName, appName, envName, timeStr);
		super.render(projectName, appName, envName, timeStr);
	}

	private void renderClasses(String projectName, String appName,
