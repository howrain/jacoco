...
public class PackageSourcePage extends TablePage<IPackageCoverage> {
	...
	public void render(String projectName, String appName, String envName,
		...
		renderSourceFilePages(projectName, appName, envName, timeStr);
	...
	private final void renderSourceFilePages(String projectName, String appName,
		...
		for (final ISourceFileCoverage s : getNode().getSourceFiles()) {
			...
			if (reader == null) {
				...
				sourcePage.render(projectName, appName, envName, timeStr);
