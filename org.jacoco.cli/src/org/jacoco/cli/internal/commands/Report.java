...
public class Report extends Command {
	...
	@Option(name = "--projectName", usage = "input name for projectName", metaVar = "<name>")
	String projectName;
	@Option(name = "--appName", usage = "input name for appName", metaVar = "<name>")
	String appName;
	@Option(name = "--envName", usage = "input name for envName", metaVar = "<name>")
	String envName;
	@Option(name = "--timeStr", usage = "input time for timeStr", metaVar = "<time>")
	String timeStr;
	...
	private void writeReports(final IBundleCoverage bundle,
		...
		visitor.visitBundle(bundle, getSourceLocator(), projectName, appName,
				envName, timeStr);
		visitor.visitEnd();
	}
